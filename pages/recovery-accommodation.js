...
<div>
  ...
  <div className={style.pic2}><Image src={pic2}  className={style.picSize} /></div>
  <div className={style.text}>
<p className={style.textContent}>
We also offer recovery accommodation design to assist people living with mental illnesses to recover
 while they are awaiting transition into the community. This accommodation will assist those that are 
 recently discharged from hospital to be equipped with daily life skills and build on their physical and
  mental capacity before reestablishing into the community. This accommodation is 24-7 fully staffed with qualified staffs.
</p>
<hr/>
<p>
